 ...
 */
class Utilisateur extends \FTT\UserBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'FTT\\UserBundle\\Entity\\Utilisateur' . "\0" . 'cinUser', '' . "\0" . 'FTT\\UserBundle\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'FTT\\UserBundle\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'FTT\\UserBundle\\Entity\\Utilisateur' . "\0" . 'dateDeNaissance', '' . "\0" . 'FTT\\UserBundle\\Entity\\Utilisateur' . "\0" . 'nationaliter', '' . "\0" . 'FTT\\UserBundle\\Entity\\Utilisateur' . "\0" . 'tel', '' . "\0" . 'FTT\\UserBundle\\Entity\\Utilisateur' . "\0" . 'gradeArbitre', '' . "\0" . 'FTT\\UserBundle\\Entity\\Utilisateur' . "\0" . 'role', '' . "\0" . 'FTT\\UserBundle\\Entity\\Utilisateur' . "\0" . 'typeArbitre', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
