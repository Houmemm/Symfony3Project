 ...
 */
class Actualites extends \Squad\FttBundle\Entity\Actualites implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['photo' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'idactualite', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'titre', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'corps', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'dateredaction', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'etat', 'photo', 'oldFile', 'tempFile', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'file'];
        }

        return ['__isInitialized__', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'idactualite', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'titre', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'corps', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'dateredaction', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'etat', 'oldFile', 'tempFile', '' . "\0" . 'Squad\\FttBundle\\Entity\\Actualites' . "\0" . 'file'];
    }
    ...
    public function getDateredaction()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDateredaction', []);
    ...
    public function setDateredaction(\DateTime $dateredaction)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateredaction', [$dateredaction]);
