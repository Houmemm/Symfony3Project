...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'fttfinal', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Squad\\FttBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\FTT\\UserBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\SquadMail\\MailBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Squad\\FttBundle\\Entity');
        $c->addDriver($b, 'FTT\\UserBundle\\Entity');
        $c->addDriver($b, 'SquadMail\\MailBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('SquadFttBundle' => 'Squad\\FttBundle\\Entity', 'FTTUserBundle' => 'FTT\\UserBundle\\Entity', 'SquadMailMailBundle' => 'SquadMail\\MailBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_70c1f076c06a9006a95e98f738d7b4afd1024f1a6e6bb6b24ac8b68840c98eed');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('FTT\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('FTT\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('FTT\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('FTT\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'FTT\\UserBundle\\Entity\\Utilisateur');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \FTT\UserBundle\Controller\AfterLoginRedirection A FTT\UserBundle\Controller\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \FTT\UserBundle\Controller\AfterLoginRedirection($this->get('router'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('FTT\\UserBundle\\Entity\\Utilisateur' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/arbitre/');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/medecin/');

        $k = new \Symfony\Component\Security\Http\AccessMap();
        $k->add($h, array(0 => 'ROLE_ADMIN'), NULL);
        $k->add($i, array(0 => 'ROLE_ARBITRE'), NULL);
        $k->add($j, array(0 => 'ROLE_MEDECIN'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('pisquad.ftt');
        $a->setPassword('skydjey+55+');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Squad\\FttBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\frontoffice\\frontBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\SquadMail\\MailBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Squad\\FttBundle/Resources/views'), 'SquadFtt');
        $instance->addPath(($this->targetDirs[3].'\\src\\FTT\\UserBundle/Resources/views'), 'FTTUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\frontoffice\\frontBundle/Resources/views'), 'frontofficefront');
        $instance->addPath(($this->targetDirs[3].'\\src\\SquadMail\\MailBundle/Resources/views'), 'SquadMailMail');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_RESPONSABLE', 1 => 'ROLE_ARBITRE', 2 => 'ROLE_ADMIN', 3 => 'ROLE_FAN', 4 => 'ROLE_MEDECIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SquadFttBundle' => 'Squad\\FttBundle\\SquadFttBundle',
                'FTTUserBundle' => 'FTT\\UserBundle\\FTTUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'frontofficefrontBundle' => 'frontoffice\\frontBundle\\frontofficefrontBundle',
                'SquadMailMailBundle' => 'SquadMail\\MailBundle\\SquadMailMailBundle',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'pisquad.ftt',
            'swiftmailer.mailer.default.transport.smtp.password' => 'skydjey+55+',
            ...
            'fos_user.model.user.class' => 'FTT\\UserBundle\\Entity\\Utilisateur',
            ...
            'buttons.facebook' => array(
                'url' => 'www.facebook.com/FederationTunisienneDeTennis/?fref=ts',
                'locale' => 'fr_FR',
                'send' => false,
                'width' => 300,
                'showFaces' => false,
