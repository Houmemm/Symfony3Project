...
/* SquadFttBundle:Sets:edit.html.twig */
class __TwigTemplate_552cc62f0e644fe691982dfdb92c86003ed500b956dd2cff55b2c5304b5b6b53 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("SquadFttBundle::layout.html.twig", "SquadFttBundle:Sets:edit.html.twig", 1);
        $this->blocks = array(
...
";
    ...
    ";
        // line 21
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : $this->getContext($context, "edit_form")), "scoreJ1", array()), 'row', array("attr" => array("class" => "form-control")));
        echo "
    ";
        // line 22
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : $this->getContext($context, "edit_form")), "scoreJ2", array()), 'row', array("attr" => array("class" => "form-control")));
        echo "
    ";
        // line 23
    ...
    <a href=\"";
        // line 26
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("back_sets", array("match" => $this->getAttribute($this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "matchMatch", array()), "idMatch", array()))), "html", null, true);
...
";
    ...
    {
        return "SquadFttBundle:Sets:edit.html.twig";
    }
    ...
    {
        return array (  181 => 41,  176 => 40,  171 => 39,  166 => 38,  161 => 37,  156 => 36,  151 => 35,  146 => 34,  141 => 33,  136 => 32,  126 => 26,  122 => 25,  118 => 24,  114 => 23,  110 => 22,  106 => 21,  102 => 20,  99 => 18,  92 => 15,  88 => 14,  84 => 13,  80 => 12,  76 => 11,  72 => 10,  68 => 9,  64 => 8,  60 => 7,  56 => 6,  52 => 5,  49 => 4,  46 => 3,  40 => 2,  11 => 1,);
    }
}
...
/*     {{ form_row(edit_form.scoreJ1, { 'attr': {'class': 'form-control'} }   ) }}*/
/*     {{ form_row(edit_form.scoreJ2, { 'attr': {'class': 'form-control'} }   ) }}*/
/*     {{form_row(edit_form.submit)}}*/
/*     {{form_end(edit_form)}}*/
/*     {{ form(delete_form) }}*/
/*     <a href="{{ path('back_sets', {'match':entity.matchMatch.idMatch} ) }}"  class="btn icon-btn btn-info">*/
/*         Retour a la liste*/
/*     </a>*/
/* */
/* */
