...
/* SquadFttBundle:MatchHasJoueur:index.html.twig */
class __TwigTemplate_6654ceb2e7ca0cf64af34a4065c13c61f570ba760df1a60817b952cbd3ecd4f4 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 2
        $this->parent = $this->loadTemplate("SquadFttBundle::layout.html.twig", "SquadFttBundle:MatchHasJoueur:index.html.twig", 2);
        $this->blocks = array(
    ...
    public function block_first1($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "                            <tr>
                                <td>";
            // line 33
            echo twig_escape_filter($this->env, $this->getAttribute($context["entity"], "JoueurCin", array()), "html", null, true);
            echo "</td>
                                <td>
                                    <a href=\"";
            // line 35
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("back_matchhasjoueur_edit", array("id" => $this->getAttribute($context["entity"], "idMatchHasJoueur", array()))), "html", null, true);
            echo "\" class=\"btn icon-btn btn-warning\">Modifier</a>
        ...
        echo "                    </tbody>
                    ...
                    <a href=\"";
        // line 42
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("back_matchhasjoueur_new", array("match" => $this->getAttribute((isset($context["mat"]) ? $context["mat"] : $this->getContext($context, "mat")), "idMatch", array()))), "html", null, true);
        echo "\" class=\"btn icon-btn btn-success\">
        <span class=\"glyphicon btn-glyphicon glyphicon-plus img-circle text-success\"></span>
        Ajouter un Joueur a ce match
    </a>&nbsp;
    <a href=\"";
        // line 46
        echo $this->env->getExtension('routing')->getPath("back_matchtennis");
...
";
    ...
    {
        return "SquadFttBundle:MatchHasJoueur:index.html.twig";
    }
    ...
    {
        return array (  207 => 64,  202 => 63,  197 => 62,  192 => 61,  187 => 60,  182 => 59,  177 => 58,  172 => 57,  167 => 56,  162 => 55,  149 => 46,  142 => 42,  138 => 40,  127 => 35,  122 => 33,  119 => 32,  115 => 31,  102 => 20,  99 => 19,  92 => 16,  88 => 15,  84 => 14,  80 => 13,  76 => 12,  72 => 11,  68 => 10,  64 => 9,  60 => 8,  56 => 7,  52 => 6,  49 => 5,  46 => 4,  40 => 3,  11 => 2,);
    }
}
/* */
...
/*                             <tr>*/
/*                                 <td>{{ entity.JoueurCin }}</td>*/
/*                                 <td>*/
/*                                     <a href="{{ path('back_matchhasjoueur_edit', { 'id': entity.idMatchHasJoueur }) }}" class="btn icon-btn btn-warning">Modifier</a>*/
/* */
/*                                 </td>*/
/*                             </tr>*/
/*                         {% endfor %}*/
/*                     </tbody>*/
/*                 </table>*/
/*                     <a href="{{ path('back_matchhasjoueur_new',{ 'match': mat.idMatch }) }}" class="btn icon-btn btn-success">*/
/*         <span class="glyphicon btn-glyphicon glyphicon-plus img-circle text-success"></span>*/
/*         Ajouter un Joueur a ce match*/
/*     </a>&nbsp;*/
