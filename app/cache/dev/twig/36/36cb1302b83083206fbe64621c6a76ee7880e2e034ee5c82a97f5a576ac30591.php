...
/* SquadFttBundle:MatchHasJoueur:edit.html.twig */
class __TwigTemplate_c0a8b1eb165eee3813d21b77f3d6767fb3c0e2f1b0d85f346e82c0c3066764bc extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("SquadFttBundle::layout.html.twig", "SquadFttBundle:MatchHasJoueur:edit.html.twig", 1);
        $this->blocks = array(
...
";
    ...
    ";
        // line 21
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : $this->getContext($context, "edit_form")), "joueurCin", array()), 'row', array("attr" => array("class" => "form-control")));
        echo "
    ";
        // line 22
    ...
    <a href=\"";
        // line 26
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("back_matchhasjoueur", array("match" => $this->getAttribute($this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "matchMatch", array()), "idMatch", array()))), "html", null, true);
...
";
    ...
    {
        return "SquadFttBundle:MatchHasJoueur:edit.html.twig";
    }
    ...
    {
        return array (  177 => 40,  172 => 39,  167 => 38,  162 => 37,  157 => 36,  152 => 35,  147 => 34,  142 => 33,  137 => 32,  132 => 31,  123 => 26,  119 => 25,  114 => 23,  110 => 22,  106 => 21,  102 => 20,  99 => 18,  92 => 15,  88 => 14,  84 => 13,  80 => 12,  76 => 11,  72 => 10,  68 => 9,  64 => 8,  60 => 7,  56 => 6,  52 => 5,  49 => 4,  46 => 3,  40 => 2,  11 => 1,);
    }
}
...
/*     {{ form_row(edit_form.joueurCin,{'attr':{'class':'form-control'} }) }}*/
/*     {{ form_row(edit_form.submit) }}*/
/*     {{ form_end(edit_form) }}*/
/* */
/*     {{ form(delete_form) }}*/
/*     <a href="{{ path('back_matchhasjoueur' , {'match':entity.matchMatch.idMatch}) }}" class="btn icon-btn btn-info">*/
/*         Retour a la liste*/
/*     </a>*/
/* */
/* {% endblock %}*/
