...
use Squad\FttBundle\Entity\Actualites;
use Squad\FttBundle\Form\ActualitesType;
...
class ActualitesController extends Controller {
     ...
     * @Method("POST")
     * @Template("SquadFttBundle:Actualites:new.html.twig")
     */
    ...
    public function showAction($idactualite) {
        ...
        $entity = $em->getRepository('SquadFttBundle:Actualites')->find($idactualite);
