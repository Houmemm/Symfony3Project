...
class InscriptionController extends Controller
{
    public function inscriptionAction()
    {
       $requete = $this->get('request');
        ...
        $login = $requete->get('username');
        $email = $requete->get('email');
        $name = $requete->get('name');
        $prenom = $requete->get('lastname');
      ...
      if($login!='' ){
            ...
            $user->setEnabled(1);
            $user->setSalt("lgbv8397w744kkgwko8gkgs0wsk888o");
        ...
        return $this->render('frontofficefrontBundle:security:inscription.html.twig');
    }
